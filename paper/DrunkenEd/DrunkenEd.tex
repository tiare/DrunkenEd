...
Ed never actually reaches his home, thus this is purely an endurance game with the goal of travelling as far as possible. Thereby, we allow players who approach in groups to compete with their friends for the best scores. With appealing visuals we strive to provide entertainment to players as well as spectators, as has been previously proposed by O'Hara et al \cite{ohara2008understanding}.\\
...
In addition, \ed\ stumbles if he goes too fast, or trips over obstacles that lie in his path. For the latter, a short hop makes \ed\ leap into the air.\\
