...
\author{
  \alignauthor{
  	...
  	\affaddr{Technische Universität Berlin}\\
  	\affaddr{Straße des 17. Juni xx}\\
  	\affaddr{Berlin, xxxxx Germany}\\
...
\def\plainkeywords{Drunken Ed, public display, large screen display, balance game, kinect, hci, interaction, gesture control}
